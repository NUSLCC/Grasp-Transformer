...
def parse_args():
    ...
    parser.add_argument('--batches-per-epoch', type=int, default=1532, help='Batches per Epoch')
    parser.add_argument('--val-batch-size', type=int, default=1, help='Validation Batch Size')
    parser.add_argument('--val-batches-per-epoch', type=int, default=5447, help='Validation Batches per Epoch')
    parser.add_argument('--description', type=str, default="jac_d_only", help='Training description')
